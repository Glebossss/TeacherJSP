...
public class UnconfirmedActivitiesEntity {
    ...
    public UnconfirmedActivitiesEntity(TeacherEntity teacherEntity, StudentEntity studentEntity, Date dateStart, Date dataEnd,  Long time, Integer money) {
    ...
    public UnconfirmedActivitiesDTO toUnconfirmedActivitiesDTO() {
        return UnconfirmedActivitiesDTO.of(id, teacherEntity, studentEntity, dateStart, dataEnd, time, money);
    }
